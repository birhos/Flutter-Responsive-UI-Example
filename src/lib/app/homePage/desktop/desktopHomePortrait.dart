...
class DesktopHomePortrait extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        preferredSize: Size.fromHeight(MyAppBarTheme.DesktopPortraitHeight),
        child: Container(
                  ...
                  Align(
                    ...
                    child: Text(
                      ...
                      style: Theme.of(context).textTheme.display1.copyWith(
                        ...
                        fontSize: MyAppBarTheme.DesktopTextSize,
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Icon(
                        ...
                        size: MyAppBarTheme.DesktopIconSize,
                        semanticLabel: "Menü",
                      ),
                    ),
                  ),
